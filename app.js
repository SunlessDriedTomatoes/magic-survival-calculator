...
// build data. Keyed by a caller-chosen id, defaults to expanded (false/absent) so nothing looks
// different from before until the user actively collapses something. Resets on page reload.
const uiCollapsed = {};
function toggleCollapsed(id) { uiCollapsed[id] = !uiCollapsed[id]; renderResultsPane(); }
